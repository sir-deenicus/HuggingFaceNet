...
let reals = "The set Q of rational numbers is incomplete. It has “gaps,” one of which occurs at √2. These gaps are really more like pinholes; they have zero width. Incompleteness is what is wrong with Q. Our goal is to complete Q by filling in its gaps. An elegant method to arrive at this goal is Dedekind cuts in which one visualizes real numbers as places at which a line may be cut with scissors"